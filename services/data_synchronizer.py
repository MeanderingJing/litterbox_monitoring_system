...
class DataSynchronizer:
    ...
    def synchronize(self, start_date: Optional[str] = None, end_date: Optional[str] = None) -> None:
        ...
        try:
            ...
            data: List[Dict[str, Any]] = get_litterbox_usage_data(start_date=start_date, end_date=end_date)
            if not data:
